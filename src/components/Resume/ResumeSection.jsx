...
const ResumeSection = ({ data }) => {
  ...
  const fetchedTimeline = useSelector(userData);

  const forExperience = fetchedTimeline.user.timeline.filter((items) => !items.forEducation)
  const forEducation = fetchedTimeline.user.timeline.filter((item) => item.forEducation );
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="st-resume-wrap">
              ...
              <div className="st-resume-timeline-wrap" >
                {
                  forEducation.map((education, index) => (
          ...
          <div className="col-lg-6">
            ...
            <div className="st-resume-wrap">
              ...
              <div className="st-resume-timeline-wrap">
                {
                  forExperience.map((experience, index) => (
