...
const Skill = ({ data }) => {
  ...
  const combinedSkills = skills.map( (skill,index) => {
    const fetchSkill = mySkills[index];

    return {
      ...skill,
      enabled:fetchSkill.enabled,
      name:fetchSkill.name,
      sequence:fetchSkill.sequence,
      percentage:fetchSkill.percentage,
      image:fetchSkill.image
    }
  })
        ...
        <div className="row">
          ...
          <div className="col-lg-6   ">
            ...
            <div className="st-progressbar-wrap ">
              {combinedSkills.map((element, index) => (
                <div
                ...
                >
                  ...
                  <div className="st-progressbar" style={{width:`${element.percentage}%`}}>
